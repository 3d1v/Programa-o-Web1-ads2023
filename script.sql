...
-- Copiando estrutura para tabela vandalizarAqui.parametros
...
-- Copiando dados para a tabela vandalizarAqui.parametros: ~1 rows (aproximadamente)
DELETE FROM `parametros`;
INSERT INTO `parametros` (`id`, `valor`) VALUES
	(1, 'Balcão de empregos');

CREATE TABLE serv_rec(  
